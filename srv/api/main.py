...
from nlu_retriever.serv import populate_db, find_similar
from nlu_retriever.serv import answer
...
def creake_embdiings() -> Tensor:
    ...
    for file_embed in files_embed:
        embeds = torch.load(f"../../data/processed/hack_digit/embeddings_train_{file_embed}.pt",
